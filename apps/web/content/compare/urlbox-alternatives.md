...
faq:
  ...
  - question: "What is the cheapest Urlbox alternative?"
    answer: "ScreenshotAPI offers pay-as-you-go credits starting at $20 for 500 screenshots with no monthly subscription. ApiFlash starts at $7/month for 1,000 screenshots."
...
| Pricing model | Credits (no expiry) | Subscription | Subscription | Subscription | Subscription |
| WebP output | ✓ | ✗ | ✗ | ✗ | ✗ |
| Dark mode | ✓ | ✓ | ✗ | ✗ | ✗ |
| Full-page capture | ✓ | ✓ | ✓ | ✓ | ✓ |
...
|---|---|---|
| [Link previews](/use-cases/link-previews) | ScreenshotAPI | Simple URL-to-image, no subscription |
