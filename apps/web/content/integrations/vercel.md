...
1. [Sign up for ScreenshotAPI](https://screenshotapi.to) and grab your API key. **5 free credits** are included.
...
Since ScreenshotAPI requires no npm packages for basic usage, your serverless functions stay well under Vercel's 250 MB limit. This leaves plenty of room for your application logic. Visit the [pricing page](/pricing) to pick the right credit tier.
