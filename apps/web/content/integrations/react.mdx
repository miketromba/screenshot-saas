...
1. [Create a free account](https://screenshotapi.to) to get your API key. 200 free screenshots per month are included to start.
...
WebP images are typically 25-35% smaller than PNG at comparable visual quality.
