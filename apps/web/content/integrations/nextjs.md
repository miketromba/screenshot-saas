...
1. [Sign up for ScreenshotAPI](https://screenshotapi.to) and grab your API key from the dashboard. You get **5 free credits** to test with immediately.
...
Check out the [pricing page](/pricing) to pick the right credit tier for your usage volume.
