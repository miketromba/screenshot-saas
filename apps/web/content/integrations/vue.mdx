...
1. [Create a free ScreenshotAPI account](https://screenshotapi.to) and copy your API key. You get **200 free screenshots per month** to start with.
...
For external caching, set `Cache-Control` headers and serve images through a CDN.
