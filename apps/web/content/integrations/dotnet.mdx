...
ScreenshotAPI works on any .NET hosting platform. No Chromium, no Selenium grid, no special container layers. Deploy to Azure App Service, AWS Lambda, Docker, or a bare VM.
