...
1. [Sign up for ScreenshotAPI](https://screenshotapi.to) and get your API key. You receive **5 free credits** on signup.
...
ScreenshotAPI works on any Laravel hosting environment: Forge, Vapor, shared hosting, Docker. No Chromium binary means smaller images and faster deployments. Visit the [pricing page](/pricing) to select the right credit tier.
