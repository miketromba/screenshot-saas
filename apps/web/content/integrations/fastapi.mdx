...
1. [Sign up for ScreenshotAPI](https://screenshotapi.to) and copy your API key. You get **200 free screenshots per month** on signup.
...
FastAPI with ScreenshotAPI deploys anywhere that runs Python. No Chromium, no system dependencies. Whether you use Docker, Fly.io, Railway, or a VPS, the integration is the same async HTTP call.
