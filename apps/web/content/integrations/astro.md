...
For server endpoints, set `Cache-Control` headers so CDNs cache the responses. Astro deployed on Vercel or Cloudflare automatically benefits from edge caching. Visit the [pricing page](/pricing) to choose the right credit volume.
