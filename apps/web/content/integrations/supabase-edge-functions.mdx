...
Supabase Edge Functions do not include built-in rate limiting. Implement request counting in your database or use Supabase RLS policies to control access.
