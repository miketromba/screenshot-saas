...
faq:
  ...
  - question: "How many credits do CI screenshots typically use?"
    answer: "It depends on your workflow. A typical setup capturing 5 pages on each PR uses 5 credits per run. With the Growth plan at 2,000 credits, that covers 400 PR builds."
relatedPages:
...
Calculate your expected credit usage: pages per run multiplied by runs per month. A workflow capturing 5 pages on 100 PRs per month uses 500 credits. The Starter plan at $20 covers this. Visit the [pricing page](/pricing) for all options.
