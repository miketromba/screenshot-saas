...
Switching from wkhtmltopdf or Grover to ScreenshotAPI typically removes 100-200 MB from your production Docker image. No Chromium, no Node.js, no Puppeteer.
