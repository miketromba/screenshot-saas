...
Configure automatic credit replenishment from your [dashboard](https://screenshotapi.to/dashboard/credits). When your balance drops below a threshold you set, we'll automatically charge your saved payment method for your chosen credit pack.
