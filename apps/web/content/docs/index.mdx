...
Sign up at [screenshotapi.to/sign-up](https://screenshotapi.to/sign-up). You'll receive **200 free screenshots per month** to start.
...
Navigate to your [dashboard](https://screenshotapi.to/dashboard) and create a new API key. Copy it — you'll only see the full key once.
...
- [Integrations](/docs/integrations) — Guides for 30+ frameworks, platforms, and automation tools
