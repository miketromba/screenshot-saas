...
faq:
  ...
  - question: "How does pricing compare?"
    answer: "Microlink Pro starts at €39/month for 46K requests with unused requests expiring monthly. ScreenshotAPI offers flexible subscriptions starting at $9/month for 1,000 screenshots, plus pay-as-you-go credit packs. For variable workloads, ScreenshotAPI is typically more cost-effective."
...
Microlink is a versatile link intelligence API that handles metadata extraction, PDF generation, and screenshots. If you are only using Microlink for screenshots, you are paying for an entire link analysis platform when all you need is an image capture endpoint. [ScreenshotAPI](/) is a dedicated screenshot API that returns image data directly, uses straightforward parameters, and offers flexible subscriptions with pay-as-you-go credit packs. This guide covers the migration.
...
**Subscription pressure.** Microlink Pro starts at €39/month for 46,000 requests. The free tier allows just 50 requests per day. Unused requests expire at month end. ScreenshotAPI offers flexible subscriptions starting at $9/month for 1,000 screenshots, plus pay-as-you-go credit packs for variable workloads.
...
| `viewport.deviceScaleFactor=2` | `retina=true` | Retina/HiDPI rendering |
...
ScreenshotAPI supports retina rendering via the `retina=true` parameter, which captures at 2x device pixel ratio:
