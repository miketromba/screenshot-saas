...
faq:
  ...
  - question: "How does pricing compare?"
    answer: "Browserless charges based on concurrent browser sessions and compute time. ScreenshotAPI offers flexible subscriptions and pay-as-you-go credit packs. For screenshot-only workloads, ScreenshotAPI is typically cheaper."
relatedPages:
