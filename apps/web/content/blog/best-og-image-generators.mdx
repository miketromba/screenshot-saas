...
faq:
  ...
  - question: "How much do OG image generators cost?"
    answer: "OGForge is completely free. @vercel/og is free if you host on Vercel. OGMagic costs $12 one-time. ScreenshotAPI starts at $9/month for 1,000 screenshots. Most template-based generators cost $9-29 per month."
...
|---|---|---|---|---|---|---|
| **ScreenshotAPI** | Screenshot | 200/month | $9/mo | 2-5s | N/A (captures real page) | Yes |
...
| Cost at 1000/mo | $0-12 | $9/mo | Free + hosting |
